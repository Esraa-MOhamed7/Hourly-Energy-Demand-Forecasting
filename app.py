...
model_path = "rf_model_sampled.pkl"

try:
    model = joblib.load(model_path)
    print("✅ Model loaded successfully")
except FileNotFoundError:
    st.error("❌ Model file not found. Please make sure 'rf_model_sampled.pkl' is in the app directory.")
...
with tab3:
    ...
    st.success("R² Score: 0.9881 (based on test data)")
    st.info("RMSE: 703.10 MW")
